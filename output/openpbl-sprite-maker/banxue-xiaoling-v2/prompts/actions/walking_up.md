Create one independent horizontal animation strip for 伴学小灵, action `walking_up`.

Input images:
- references/standard-view-01.png — standard-view reference
- canonical/canonical-base.png — canonical-base identity lock
- references/layout-guides/walking_up.png — layout-only guide for 8 slots; never copy visible guide pixels

Action semantic: 背向或向上移动。
Required frame count: 8
Layout reference: references/layout-guides/walking_up.png
