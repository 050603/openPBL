Create one independent horizontal animation strip for 伴学小灵, action `sit_down`.

Input images:
- references/standard-view-01.png — standard-view reference
- canonical/canonical-base.png — canonical-base identity lock
- references/layout-guides/sit_down.png — layout-only guide for 6 slots; never copy visible guide pixels

Action semantic: 坐回座位。
Required frame count: 6
Layout reference: references/layout-guides/sit_down.png
