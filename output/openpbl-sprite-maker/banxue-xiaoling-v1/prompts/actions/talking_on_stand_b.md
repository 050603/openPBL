Create one independent horizontal animation strip for 伴学小灵, action `talking_on_stand_b`.

Input images:
- references/standard-view-01.png — standard-view reference
- canonical/canonical-base.png — canonical-base identity lock
- references/layout-guides/talking_on_stand_b.png — layout-only guide for 5 slots; never copy visible guide pixels

Action semantic: 站立发言动作 B。
Required frame count: 5
Layout reference: references/layout-guides/talking_on_stand_b.png
