...
function TableFloatingToolbarContent({
  ...
  return (
    ...
    >
      ...
      >
        <ToolbarGroup>
          <ColorDropdownMenu tooltip="单元格背景颜色">
            <PaintBucketIcon />
          </ColorDropdownMenu>
          {canMerge && onMerge && (
            <ToolbarButton
  ...
  return (
    <PlateElement
      ...
      className={cn(
        ...
        Boolean(borders.bottom?.size) && 'before:border-b before:border-b-border',
        Boolean(borders.right?.size) && 'before:border-r before:border-r-border',
        Boolean(borders.left?.size) && 'before:border-l before:border-l-border',
        Boolean(borders.top?.size) && 'before:border-t before:border-t-border'
      )}
      style={
        {
