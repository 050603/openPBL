...
import { useCanvasStore, useKeyboardStore } from '@openmaic/lib/store';
import { useHistorySnapshot } from '@openmaic/lib/hooks/use-history-snapshot';
import type { PPTElement } from '@openmaic/dsl';
import type { AlignmentLineProps } from '@openmaic/lib/types/edit';
import { getRectRotatedRange, uniqAlignLines, type AlignLine } from '@openmaic/lib/utils/element';
import { useCanvasOperations } from '@openmaic/lib/hooks/use-canvas-operations';
