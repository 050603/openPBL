...
import type { EditorHint, InsertPaletteItem, SurfaceState } from '@openmaic/lib/edit/scene-editor-surface';
import { useI18n } from '@openmaic/lib/hooks/use-i18n';
import { useStageStore } from '@openmaic/lib/store/stage';
import type { QuizContent, QuizQuestionType } from '@openmaic/lib/types/stage';
import {
  addOption,
  addQuestion,
  deleteOption,
