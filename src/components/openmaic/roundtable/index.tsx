...
import { CanvasToolbar } from '@openmaic/components/canvas/canvas-toolbar';
import { useAudioRecorder } from '@openmaic/lib/hooks/use-audio-recorder';
import { useI18n } from '@openmaic/lib/hooks/use-i18n';
import { toast } from 'sonner';
import { useSettingsStore, PLAYBACK_SPEEDS } from '@openmaic/lib/store/settings';
import { ProactiveCard } from '@openmaic/components/chat/proactive-card';
import { PresentationSpeechOverlay } from '@openmaic/components/roundtable/presentation-speech-overlay';
import { AvatarDisplay } from '@openmaic/components/ui/avatar-display';
import { HoverCard, HoverCardTrigger, HoverCardContent } from '@openmaic/components/ui/hover-card';
import { useAgentRegistry } from '@openmaic/lib/orchestration/registry/store';
import { DEFAULT_TEACHER_AVATAR, DEFAULT_USER_AVATAR } from '@openmaic/components/roundtable/constants';
