...
import { Input } from '@openmaic/components/ui/input';
...
import { isLLMProviderConfigured } from '@openmaic/lib/store/settings-validation';
import { PDF_PROVIDERS } from '@openmaic/lib/pdf/constants';
import type { PDFProviderId } from '@openmaic/lib/pdf/types';
import { WEB_SEARCH_PROVIDERS, getWebSearchProviderDisplayName } from '@openmaic/lib/web-search/constants';
import type { WebSearchProviderId } from '@openmaic/lib/web-search/types';
import type { ProviderId } from '@openmaic/lib/ai/providers';
import type {
  ModelInfo,
  ThinkingConfig,
  ThinkingEffort,
...
import type { SettingsSection } from '@openmaic/lib/types/settings';
import { MediaPopover } from '@openmaic/components/generation/media-popover';
import { COURSE_MATERIAL_ACCEPT, isSupportedCourseMaterial } from '@openmaic/lib/document/mime';
