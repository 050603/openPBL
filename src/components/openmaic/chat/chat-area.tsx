...
import type { SessionType } from '@openmaic/lib/types/chat';
import type { LectureNoteEntry } from '@openmaic/lib/types/chat';
import type { DiscussionRequest } from '@openmaic/components/roundtable';
import type { Action, SpeechAction, DiscussionAction } from '@openmaic/lib/types/action';
...
import { Tabs, TabsList, TabsTrigger, TabsContent } from '@openmaic/components/ui/tabs';
