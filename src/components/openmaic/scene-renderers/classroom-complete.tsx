...
import type { Scene, SceneType } from '@openmaic/lib/types/stage';
import { summarizeScenes } from '@openmaic/lib/classroom/complete-summary';
import { readAnswersForSummary } from '@openmaic/lib/quiz/persistence';
