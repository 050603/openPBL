...
import { resolveAgentVoice, getSelectableProvidersWithVoices } from '@openmaic/lib/audio/voice-resolver';
import { playBrowserTTSPreview } from '@openmaic/lib/audio/browser-tts-preview';
import { useVoxCPMVoiceProfiles } from '@openmaic/lib/audio/voxcpm-voices';
import { resolveAgentVoiceOptions } from '@openmaic/lib/audio/agent-voice';
...
import type { ProviderWithVoices } from '@openmaic/lib/audio/voice-resolver';
    ...
    <div ref={containerRef} className="relative w-96">
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-stone-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2 py-1.5">
