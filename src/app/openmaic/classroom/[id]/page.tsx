...
import { loadImageMapping } from '@openmaic/lib/utils/image-storage';
import { useEffect, useRef, useState, useCallback } from 'react';
import { useParams } from 'next/navigation';
import { useSceneGenerator } from '@openmaic/lib/hooks/use-scene-generator';
...
import { generateMediaForOutlines } from '@openmaic/lib/media/media-orchestrator';
  ...
  const loadClassroom = useCallback(async () => {
    try {
      ...
      const { loadGeneratedAgentsForStage, useAgentRegistry } =
        await import('@openmaic/lib/orchestration/registry/store');
      const generatedAgentIds = await loadGeneratedAgentsForStage(classroomId);
      const { useSettingsStore } = await import('@openmaic/lib/store/settings');
      const { restoreAgentSelection } =
        await import('@openmaic/lib/orchestration/registry/agent-selection');
