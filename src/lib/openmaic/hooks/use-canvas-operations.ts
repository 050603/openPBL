...
import { useSceneData, useSceneSelector } from '@openmaic/lib/contexts/scene-context';
import {
  useCanvasStore,
  type SpotlightOptions,
  type HighlightOverlayOptions,
} from '@openmaic/lib/store/canvas';
...
import { ElementAlignCommands, ElementOrderCommands } from '@openmaic/lib/types/edit';
