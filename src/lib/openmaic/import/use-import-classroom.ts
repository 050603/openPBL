...
import type { AudioFileRecord, MediaFileRecord, GeneratedAgentRecord } from '@openmaic/lib/utils/database';
import type { ClassroomManifest, ManifestScene } from '@openmaic/lib/export/classroom-zip-types';
import { rewriteAudioRefsToIds } from '@openmaic/lib/export/classroom-zip-utils';
