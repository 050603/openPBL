...
import type { ProvidersConfig } from '@openmaic/lib/types/settings';
...
} from '@openmaic/lib/store/settings-validation';
        ...
        fetchServerProviders: async () => {
          try {
            ...
            const data = (await res.json()) as {
              providers: Record<string, { models?: string[]; defaultModel?: string; priority?: number }>;
              // TTS additionally carries optional defaults used by course
              ...
              image: Record<string, { models?: string[]; defaultModel?: string; priority?: number }>;
              video: Record<string, { models?: string[]; defaultModel?: string; priority?: number }>;
              webSearch: Record<string, { priority?: number }>;
