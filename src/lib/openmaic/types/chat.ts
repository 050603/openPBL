...
import type { Stage, Scene, StageMode } from '@openmaic/lib/types/stage';
import type { AgentTurnSummary, WhiteboardActionRecord } from '@openmaic/lib/orchestration/types';
